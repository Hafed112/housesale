...
export default function CreateListing() {
  ...
  const onSubmit = async(e) =>{
    ...
    if(!latitude || !longitude){
        setLoading(false);
        toast.error("the latitude and longitude are required");
        return;
    }
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
        <h1 className="text-3xl text-center mt-11 font-bold">Create a Listing</h1>
        <form onSubmit={onSubmit}>
            <p className='text-lg mt-6 font-semibold text-start mb-1'>Sell / Rent</p>
            <div className="flex">
            ...
            <p className='text-lg mt-6 font-semibold text-start mb-1'>Name</p>
            <input type="text" id="name" value={name}
                onChange={onChange} placeholder='Name' maxLength="32" minLength="10"
            ...
            <p className='text-lg mt-6 font-semibold text-start mb-1'>Parking spot</p>
            <div className="flex">
            ...
            <p className='text-lg mt-6 font-semibold text-start mb-1'>Furnished</p>
            <div className="flex">
            ...
            <p className='text-lg mt-6 font-semibold text-start mb-1'>Address</p>
            ...
            {!geolocationEnabled &&(
                <div className='flex space-x-6 justify-start mb-6'>
                    <div className=''>
                        <p className='text-lg font-semibold text-start'>Latitude</p>
                    ...
                    <div className=''>
                        <p className='text-lg font-semibold text-start'>Longitude</p>
            ...
            <p className='text-lg  font-semibold text-start mb-1'>Description</p>
            <textarea type="text" id="description" value={description}
                ...
                mb-6'
            />
            <p className='text-lg font-semibold text-start mb-1'>Offer</p>
            ...
            <div className='flex items-center mb-6'>
                <div className=''>
                    <p className='text-lg font-semibold text-start mb-1'>Regular price</p>
            ...
            </div>
            {
                offer && (
                    <div className='flex items-center mb-6'>
                        <div className=''>
                            <p className='text-lg font-semibold text-start mb-1'>Discounted price</p>
                            <div className='flex w-full justify-center items-center space-x-6'>
            ...
            <div className=''>
                <p className='text-lg font-semibold text-start'>Images</p>
             ...
             active:bg-blue-800 active:shadow-lg transition mt-6
